...
def podaac_webdav(USER, PASSWORD, parser=lxml.etree.HTMLParser()):
    ...
    gravtk.utilities.build_opener(
        USER, PASSWORD, password_manager=True, authorization_header=True, urs=URS
    )
    ...
    parameters = gravtk.utilities.urlencode(
        {
            "client_id": "lRY01RPdFZ2BKR77Mv9ivQ",
            "response_type": "code",
...
def main():
    ...
    parser.add_argument(
        ...
        "-W",
        type=str,
        default=os.environ.get("PODAAC_PASSWORD"),
